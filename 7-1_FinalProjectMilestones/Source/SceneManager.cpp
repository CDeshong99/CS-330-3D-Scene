...
void SceneManager::SetupSceneLights()
{
	...
	// Light 3 
	m_pShaderManager->setVec3Value("lightSources[2].position", 0.0f, 8.0f, -1.0f);  
...
void SceneManager::RenderCoffeeMug()
{
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(-3.5f, 0.5f, -0.8f);  
	...
	positionXYZ = glm::vec3(-2.8f, 0.9f, -0.8f);  
...
void SceneManager::RenderLaptop()
{
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 0.6f, -1.0f);  
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 1.5f, -1.8f);  
	...
	/*** Laptop Screen Display (Blue Screen) ***/
	scaleXYZ = glm::vec3(2.8f, 0.01f, 1.8f);  
	XrotationDegrees = -75.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 1.55f, -1.72f);  

	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(0.0f, 0.4f, 1.0f, 1.0f);  
	m_basicMeshes->DrawBoxMesh();

	/*** Laptop Keyboard Area ***/
	scaleXYZ = glm::vec3(2.6f, 0.02f, 1.6f);  
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(0.0f, 0.71f, -1.0f);  
...
void SceneManager::RenderDeskLamp()
{
	...
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	positionXYZ = glm::vec3(3.5f, 0.5f, -1.0f);  

	SetTransformations(scaleXYZ, XrotationDegrees, YrotationDegrees, ZrotationDegrees, positionXYZ);
	SetShaderColor(0.5f, 0.5f, 0.5f, 1.0f);  
	m_basicMeshes->DrawCylinderMesh();

	/*** Lamp Stem (Tall Cylinder) ***/
	scaleXYZ = glm::vec3(0.2f, 3.26f, 0.2f);
	positionXYZ = glm::vec3(3.5f, 0.7f, -2.0f);  
	...
	positionXYZ = glm::vec3(3.5f, 4.0f, -1.0f);  
